...
--
-- Table structure for table `institution_human`
--

DROP TABLE IF EXISTS `institution_human`;
...
CREATE TABLE `institution_human` (
  ...
  PRIMARY KEY (`ID`),
  KEY `AppUser` (`AppUser`),
  CONSTRAINT `institution_human_ibfk_1` FOREIGN KEY (`AppUser`) REFERENCES `application_user` (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=cp1250 COLLATE=cp1250_croatian_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `institution_human`
--

LOCK TABLES `institution_human` WRITE;
/*!40000 ALTER TABLE `institution_human` DISABLE KEYS */;
/*!40000 ALTER TABLE `institution_human` ENABLE KEYS */;
UNLOCK TABLES;
