...
CREATE TABLE `application_user` (
  ...
  `Name` varchar(128) COLLATE cp1250_croatian_ci NOT NULL,
  `PassSalt` varchar(24) COLLATE cp1250_croatian_ci NOT NULL,
  `PassHash` varchar(24) COLLATE cp1250_croatian_ci NOT NULL,
  `Role` int(11) NOT NULL,
  PRIMARY KEY (`ID`),
  KEY `Role` (`Role`),
  CONSTRAINT `application_user_ibfk_1` FOREIGN KEY (`Role`) REFERENCES `application_user_role` (`ID`)
